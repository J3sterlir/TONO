...
<template>
    <div class="min-h-screen bg-[#131315] text-white sm:ml-64 font-Sora">
      ...
      <div
          ...
          <ul class="space-y-2 cursor-pointer">
            <li>
              <a @click="navigateTo('/admin/dashboard')"
                class="flex items-center px-2 py-1.5 text-body rounded-base hover:bg-[#B4B8DA]/20 hover:rounded">
            ...
            <li>
              <a @click="navigateTo('/admin/tags')"
                class="flex items-center px-2 py-1.5 text-body rounded bg-[#B4B8DA]">
                <Icon name="ic:baseline-label" class="text-2xl text-[#444865]" />
                <span class="flex-1 ms-3 whitespace-nowrap text-[#444865] font-bold">Tags</span>
              </a>
            </li>
            <li>
            ...
            <li>
              <a @click="navigateTo('/admin/users')"
                class="flex items-center px-2 py-1.5 text-body rounded-base hover:bg-neutral-tertiary hover:text-fg-brand group rounded">
        ...
        <div>
          <button @click="handleLogout" class="flex items-center gap-2 px-2 py-1.5 text-body rounded-base hover:bg-neutral-tertiary hover:text-fg-brand group w-full text-left">
